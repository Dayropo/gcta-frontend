        ...
        <main className="w-full p-12">
          <section className="relative h-96 w-full">
            ...
            <Card className="absolute -bottom-8 left-8 z-10 max-w-sm">
              <CardHeader>
                <CardTitle className="text-2xl">{data[0].title}</CardTitle>
                <CardDescription className="flex items-center gap-1.5">
                  <p className="text-xs text-gray-400">{data[0].author.name}</p>
                  <p className="text-xs text-gray-400">
                    {moment(data[0].publishedAt).format("MMMM DD, YYYY")}
                  </p>
                </CardDescription>
              </CardHeader>
            </Card>
