...
const EditPostPage = ({ slug }: { slug: string }) => {
    ...
    onSubmit: async (values, { resetForm }) => {
      await axios
        ...
        .then(response => {
          ...
          resetForm()
          queryClient.invalidateQueries({ queryKey: ["post", slug], refetchType: "all" })
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-5xl font-poppins">
        ...
        {status === "success" && (
          <main className="px-4 py-8 sm:p-12">
            <h3 className="text-lg font-semibold sm:text-2xl">Edit post</h3>
